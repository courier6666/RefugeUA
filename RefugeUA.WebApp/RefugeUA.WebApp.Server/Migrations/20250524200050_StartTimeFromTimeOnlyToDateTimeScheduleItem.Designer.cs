...
namespace RefugeUA.WebApp.Server.Migrations
{
    ...
    [Migration("20250524200050_StartTimeFromTimeOnlyToDateTimeScheduleItem")]
    partial class StartTimeFromTimeOnlyToDateTimeScheduleItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RefugeUA.DatabaseAccess.Identity.AppRole", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RefugeUA.DatabaseAccess.Identity.AppUserRole", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("RefugeUA.DatabaseAccess.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RefugeUA.DatabaseAccess.Identity.AppUserRole", b =>
                {
                    ...
                    b.HasOne("RefugeUA.DatabaseAccess.Identity.AppRole", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
