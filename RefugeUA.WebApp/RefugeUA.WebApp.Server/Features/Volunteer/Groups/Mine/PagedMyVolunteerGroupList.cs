...
namespace RefugeUA.WebApp.Server.Features.Volunteer.Groups.Mine
{
    public class PagedMyVolunteerGroupList : IFeatureEndpoint
    {
        public static async Task<IResult> PagedMyVolunteerGroupListAsync(
            ...
            [FromServices] IHttpContextAccessor httpContextAccessor)
        {
            ...
            var volunteerGroups = dbContext.VolunteerGroups.
                ...
                AsQueryable().
                Where(g => g.Admins.Any(a => a.Id == userId));
        ...
        {
            app.MapGet("api/volunteer/groups/mine/paged", PagedMyVolunteerGroupListAsync)
                .Produces<PagingInfo<VolunteerGroupResult>>(StatusCodes.Status200OK)
                .Produces(StatusCodes.Status400BadRequest)
                .Produces(StatusCodes.Status404NotFound)
                .WithName("PagedListMyVolunteerGroups")
                .WithTags("Volunteer");
        }
    }
}
