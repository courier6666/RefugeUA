...
namespace RefugeUA.WebApp.Server.Features.Authentication.ForbidUser
{
    public class ForbidUser : IFeatureEndpoint
    {
        public static async Task<IResult> ForbidUserAsync(
            [FromRoute] long id,
        ...
        {
            app.MapPatch("api/auth/users/{id:long}/forbid", ForbidUserAsync)
                .WithName("ForbidUser")
