...
{
    public static class DetailAccomodationAnnouncementMapping
    {
        public static Expression<Func<AccomodationAnnouncement, AccomodationAnnouncementResult>> Expression
            => a => new AccomodationAnnouncementResult()
            {
                Id = a.Id,
                Title = a.Title,
                Content = a.Content,
