...
@Component({
  selector: 'app-my-followed-volunteer-groups',
  standalone: false,
  templateUrl: './my-followed-volunteer-groups.component.html',
  styleUrl: './my-followed-volunteer-groups.component.css'
})
export class MyFollowedVolunteerGroupsComponent {
  ...
  loadVolunteerGroups() {
    ...
    this.subscription = this.volunteerGroupService.getFollowedVolunteerGroups(this.currentPage, 10, this.prompt).subscribe({
      next: (response) => {
