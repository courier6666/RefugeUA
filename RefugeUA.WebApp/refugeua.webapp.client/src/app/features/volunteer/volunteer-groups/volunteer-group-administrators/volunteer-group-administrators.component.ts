...
@Component({
  selector: 'app-volunteer-group-administrators',
  standalone: false,
  templateUrl: './volunteer-group-administrators.component.html',
  styleUrl: './volunteer-group-administrators.component.css'
})
export class VolunteerGroupAdministratorsComponent {
  users: User[] = [];
  ...
  loadUsers() {
    ...
    this.subscription = this.volunteerGroupService.getVolunteerGroupAdmins(this.volunteerGroup.id!, this.currentPage, 10, this.prompt).subscribe({
      next: (response) => {
